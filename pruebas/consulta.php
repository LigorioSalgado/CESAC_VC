...
define('DB_USER', 'ingreso_jriverai');
define('DB_PASS', 'caracoles');
define('DB_NAME', 'ingreso_jriverai');
$id = $_SESSION['id'];
...
$requests = array();
$result = mysql_query("SELECT * FROM Reportes WHERE ID_Usuario = '$id'", $dbLinkId);
