    ...
    <body>
        <?php
            if ($requests) {
                ...
                ->addColumnAfter('acciones', '<a href="editar.php?id=$ID_Reporte$" style="color: blue;">Editar</a> - <a href="eliminar.php?id=$ID_Reporte$" onclick="return confirm(\'Estas seguro de eliminar el reporte: $ID_Reporte$?\')" style="color: blue;">Eliminar</a>', 'Acciones', array('align' => 'center'))
