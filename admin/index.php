    ...
    <div id="header">
        ...
        <nav id="nav">
          <ul>
            ...
            <li><a href="solicitarServicio.php">Alta de Servicio</a></li>
              <li><a href="solicitarServicio.php">Añadir Usuario</a></li>
      ...
      <div class="holder_content1">
        <section class="group4">
         ...
         <center> <p>Servicio es toda solicitud prestada ante el Gobierno para que realice obras o prestaciones a los que está obligado, en beneficio tuyo y de tu comunidad.</p></center>
        <section class="group5">
        <center>  <h3>Pasos</h3> </center>
          <center>
            <p><span class="purple">1)</span><a href="solicitarServicio.php"><img src="../images/btnSolicitarServicio.png" width="240" height="115" alt="Solicitar un servicio"/></a></p>
            ...
            <p><span class="purple">3)</span><a href="anadirEmpleado.php"><img src="../images/btnAnadir.png" width="240" height="115" alt="Añadir solicitud"/></a></p>
         </center>
        </section>
       </div>
      <!--end holder-->
