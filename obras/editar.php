  ...
  switch ($num) {
    case 1:
        return "<input type='radio' id='rbEstado' name='rbEstado' value='0'>Nececita revisión 
                ...
                <input type='radio' id='rbEstado' name='rbEstado' value='2'>En proceso 
                <input type='radio' id='rbEstado' name='rbEstado' value='3'>Terminado
                ";
        break;
    case 2:
        return "<input type='radio' id='rbEstado' name='rbEstado' value='0'>Nececita revisión
                <input type='radio' id='rbEstado' name='rbEstado' value='1'>En trámite
                <input type='radio' id='rbEstado' name='rbEstado' checked='yes' value='2'>En proceso
                <input type='radio' id='rbEstado' name='rbEstado' value='3' >Terminado
                ";
        break;
    case 3:
        return "<input type='radio' id='rbEstado' name='rbEstado' value='0'>Nececita revisión
                <input type='radio' id='rbEstado' name='rbEstado' value='1'>En trámite
                <input type='radio' id='rbEstado' name='rbEstado' value='2' >En proceso
                <input type='radio' id='rbEstado' name='rbEstado' checked='yes' value='3' >Terminado
                ";
        break;
     default:
...
function servicio($num){
  switch ($num) {
      case 1:
          return "<select id='selServicio' name='selServicio' disabled>
