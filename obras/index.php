...
<head>
  <meta charset="UTF-8">
  <title>CESAC.VC - Operativos</title>
       ...
       <Center> <a href="index.html" id="logo"><img src="../images/cesa.png" width="221" height="100" alt="logo"/></a> </Center>   
        ...
        <nav id="nav">
          <ul>
            ...
            <li><a href="consultarSolicitudes.php">Revisar solicitudes</a></li>
      ...
      <link rel="stylesheet" href="cssslider_files/csss_engine1/style.css">
        ...
        <section class="group5">
          <center><h3>Pasos</h3></center>
            <center>
            <p><span class="purple">1)</span><a href="consultarSolicitudes.php"><img src="../images/btnRevisar.png" width="240" height="115" alt="Consultar el estado se de solucitud"/></a></p><br />
          </center>
        </section>
      </div>
      <!--end holder-->
