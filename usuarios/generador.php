...
function Header() //Encabezado
    {
        ...
        $this->Cell(30,25,'',0,0,'C',$this->Image('../images/cesa.png', 85,12,50,20));
       ...
       // $this->Cell(40,25,'',0,0,'C',$this->Image('/opt/lampp/htdocs/cesac/images/gdf.png', 175, 12, 19));
	...
	$pdf->cell(0,9,"El c.".$nombre." solicito un servicio a la oficina de CESAC; ",0,1,'L');
	$pdf->Ln(1);
	$pdf->cell(0,9," CESAC  se compromete a cumplir  lo siguiente:",0,1,'L');
	$pdf->Ln(1);
