    ...
    <div id="header">
        ...
        <nav id="nav">
          <ul>
           <li><a href="index.php">Inicio</a></li>
            <li  ><a href="consultarServicio.php">Consultar Servicio</a></li>
      ...
      <section class="wrapper style1">
        <div class="container">
            <hgroup>
                <br />
                <h3>Imprimir Constancia</h3>
                <iframe src="generador.php" scrolling="yes" width="105%" height="600" frameborder="0">
